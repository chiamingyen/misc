...
if site_config == "OpenShift":
    ...
    SQLite_data_dir = "V:/pyforum_db"
    download_root_dir = "V:/pyforum"
    template_root_dir = "V:/pyforum"
...
if site_config == "OpenShift":
    ...
    os.system("V:/GoogleChromePortable/GoogleChromePortable.exe http://localhost:8083")
# 啟動時採用 myconfig 的設定
